...
namespace Catch {
    namespace Benchmark {
        namespace Detail {
            ...
            using ResultOf_t = typename std::invoke_result<F, Ts...>::type;
...
namespace Catch {
    namespace Benchmark {
        ...
        template <typename Clock, typename F, typename ... Ts>
        using TimingOf = Timing<ClockDuration<Clock>, Detail::CompleteType_t<Detail::ResultOf_t<F, Ts...>>>;
    } // namespace Benchmark
} // namespace Catch
...
// Teaching convenience wrappers
#define PROVIDED_TEST(name) TEST_CASE(name, "[provided]")
#define STUDENT_TEST(name) TEST_CASE(name, "[student]")
